...
let test_cfg () =
  ...
  test_assert
    "Mainnet is production"
    (String.equal Sushiswap.Cfg.mainnet.api_url Sushiswap.Cfg.production.api_url);
  test_assert "Default no API key" (Option.is_none Sushiswap.Cfg.production.api_key);
  let with_key =
    Sushiswap.Cfg.with_api_key ~api_key:"test_key" Sushiswap.Cfg.production
  in
    test_assert
      "Can set API key"
  ...
  in
    (match Sushiswap.Types.swap_quote_of_yojson quote_json with
     | Ok quote ->
       ...
       test_assert
         "Token in"
         (String.equal quote.tokenIn "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2");
       test_assert
         "Token out"
         (String.equal quote.tokenOut "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48");
    ...
    in
      ...
      | Ok pool ->
        ...
        test_assert
          "Pool address"
          (String.equal pool.address "0x397FF1542f962076d0BFE58eA045FfA2d347ACa0");
        test_assert
          "Token0"
          (String.equal pool.token0 "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2");
        test_assert
          "Token1"
          (String.equal pool.token1 "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48");
