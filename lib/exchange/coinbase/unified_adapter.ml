(** Unified Coinbase Adapter - Consolidates Coinbase's order book, ledger, and session implementations
...
(** Coinbase's Order Book implementation *)
module Order_book = Order_book

(** Coinbase's Ledger implementation *)
module Ledger = Ledger

(** Coinbase's Session implementation *)
