(** Unified Hyperliquid Adapter - Consolidates Hyperliquid's order book, ledger, and session implementations
...
(** Hyperliquid's Order Book implementation *)
module Order_book = Order_book

(** Hyperliquid's Ledger implementation *)
module Ledger = Ledger

(** Hyperliquid's Session implementation *)
