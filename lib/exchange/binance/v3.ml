  ...
  module Params = struct
    let params =
      ...
      [%map_open
        ...
        and icebergQty =
          string_flag_option ~field_name:"icebergQty" ~doc:"Iceberg quantity"
        and newOrderRespType =
          string_flag_option
            ~field_name:"newOrderRespType"
            ~doc:"Response type (ACK, RESULT, FULL)"
        and recvWindow =
          int_flag_option ~field_name:"recvWindow" ~doc:"Receive window (ms)"
        in
          { symbol
          ; side
          ; order_type
  ...
  module Params = struct
    let params =
      ...
      [%map_open
        ...
        and newClientOrderId =
          string_flag_option ~field_name:"newClientOrderId" ~doc:"New client order ID"
        and recvWindow =
          int_flag_option ~field_name:"recvWindow" ~doc:"Receive window (ms)"
        in
          {symbol; orderId; origClientOrderId; newClientOrderId; recvWindow}]
