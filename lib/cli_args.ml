...
let string_flag ~field_name ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.required Command.Param.string)
      ~doc
...
let string_flag_opt ~field_name ~default ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default Command.Param.string)
      ~doc
...
let int_flag_opt ~field_name ~default ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default Command.Param.int)
      ~doc
...
let int64_flag_opt ~field_name ~default ~doc =
  ...
  in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default int64_arg_type)
      ~doc
...
let float_flag_opt ~field_name ~default ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default Command.Param.float)
      ~doc
...
let bool_flag ~field_name ~default ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default Command.Param.bool)
      ~doc
...
let string_list_flag ~field_name ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag ("-" ^ flag_name) (Command.Param.listed Command.Param.string) ~doc

(** Int list flag (can be specified multiple times) *)
let int_list_flag ~field_name ~doc =
  let flag_name = field_to_flag_name field_name in
    Command.Param.flag ("-" ^ flag_name) (Command.Param.listed Command.Param.int) ~doc
...
let enum_flag_opt ~field_name ~type_name ~of_string_opt ~all ~to_string ~default ~doc =
  ...
  let arg_type = enum_arg_type ~type_name ~of_string_opt ~all ~to_string in
    Command.Param.flag
      ("-" ^ flag_name)
      (Command.Param.optional_with_default default arg_type)
      ~doc
